...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="nama_product">{{ trans('cruds.product.fields.nama_product') }}</label>
                <input class="form-control {{ $errors->has('nama_product') ? 'is-invalid' : '' }}" type="text" nama_product="nama_product" id="nama_product" value="{{ old('nama_product', $product->nama_product) }}">
                @if($errors->has('nama_product'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nama_product') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.nama_product_helper') }}</span>
            </div>
            <div class="form-group">
